...
public:
	...
	Sim(short type, long ID, int species, long parent1ID, long parent2ID, int speciesParent1ID, int speciesParent2ID, float energyMax, short speedMax, short ageMax, short vision, short repAge, float distanceEvol, float stateBirth, unsigned char nbGenes, short genderVal, short isInvasive, float defence = 0, float coopDefence = 0, short persuasionVal = 0);//Add Gender /MRE/
	// for new born individuals
	Sim(short type, long ID, int species, long parent1ID, long parent2ID, int speciesParent1ID, int speciesParent2ID, float distanceEvol, unsigned char nbGenes, short genderVal, short isInvasive);//Add Gender /MRE/
	...
	short getIsInvasive()			{ return isInvasive; }
	void setIsInvasive(short i)		{ isInvasive = i; }
